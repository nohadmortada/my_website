...
- ""
date: "2021-09-30"
description: Analysed Climate change and temperature anomalies, Global Warming and Political Views, and US Presidency # the title that will show up once someone gets to this page
draft: false
image: America.jpg  # save picture in \static\img\blogs. Acceptable formats= jpg, jpeg, or png . Your iPhone pics wont work

keywords: ""
slug: homework2_website # slug is the shorthand URL address... no spaces plz
title: Data Analytics for Finance Homework 2
---
...
global_warming_pew <- read_csv("/Users/nohadmessimortada/Desktop/ca09.mfa2022/data/global_warming_pew.csv")
```
